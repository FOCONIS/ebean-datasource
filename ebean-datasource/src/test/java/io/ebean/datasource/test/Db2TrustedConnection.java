 ...
 */
class Db2TrustedConnection implements Connection {
  ...
  Db2TrustedConnection(DB2Connection delegate, byte[] cookie, String defaultUser) throws SQLException {
  ...
  boolean switchUser(String user, String password) throws SQLException {
    ...
    if (!Objects.equals(user, this.user) || !Objects.equals(password, this.password)) {
      ...
      int transactionIsolation = delegate.getTransactionIsolation();
      boolean autocommit = delegate.getAutoCommit();
      delegate.reuseDB2Connection(cookie, user, password, null, null, null, new Properties());
      this.user = user;
      this.password = password;
      delegate.setAutoCommit(autocommit);
      delegate.setTransactionIsolation(transactionIsolation);
      return true;
    }
    return false;
  }
  ...
  public boolean isWrapperFor(Class<?> iface) throws SQLException {
    if (iface == Db2TrustedConnection.class) {
      return true;
    }
