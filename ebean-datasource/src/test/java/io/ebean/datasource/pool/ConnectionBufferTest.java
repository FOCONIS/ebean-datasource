...
class ConnectionBufferTest {
  ...
  void test() {
    ...
    PooledConnection r0 = b.popFree().pc;
    ...
    PooledConnection r1 = b.popFree().pc;
    assertSame(p2, r1);
    PooledConnection r2 = b.popFree().pc;
    assertSame(p1, r2);

    assertEquals(1, b.freeSize());
    b.addFree(p2);
    assertEquals(2, b.freeSize());
    PooledConnection r3 = b.popFree().pc;
    assertSame(p2, r3);
    assertEquals(1, b.freeSize());
    PooledConnection r4 = b.popFree().pc;
    assertSame(p0, r4);
    assertEquals(0, b.freeSize());
    ...
    PooledConnection r5 = b.popFree().pc;
    assertSame(p0, r5);
    assertEquals(2, b.freeSize());

    PooledConnection r6 = b.popFree().pc;
    assertSame(p1, r6);
    assertEquals(1, b.freeSize());

    PooledConnection r7 = b.popFree().pc;
    assertSame(p2, r7);
    assertEquals(0, b.freeSize());
