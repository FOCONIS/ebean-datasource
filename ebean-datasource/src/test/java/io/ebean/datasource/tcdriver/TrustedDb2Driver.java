...
public class TrustedDb2Driver implements Driver {
  ...
  public Connection connect(String url, Properties info) throws SQLException {
    ...
    Object[] objects = ds1.getDB2TrustedPooledConnection(user, properties.getProperty("password"), properties);
    DB2PooledConnection pooledCon = (DB2PooledConnection) objects[0];
    byte[] cookie = (byte[]) objects[1];

    return new TrustedDb2Connection((DB2Connection) pooledCon.getConnection(), cookie, user);
  }
